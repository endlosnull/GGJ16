...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'pitzweb.data';
    var REMOTE_PACKAGE_BASE = 'pitzweb.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 6339218;
      var PACKAGE_UUID = '5f2f7b00-a965-4100-9e66-611c392af243';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 2805637, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(2805637, 2806252, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(2806252, 4814900, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(4814900, 6311592, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(6311592, 6339218, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_pitzweb.data');

    };
    Module['addRunDependency']('datafile_pitzweb.data');
